# this program is a simple text-based adventure game where the user makes choices to navigate through a treasure island.
# The game ends with a message based on the user's choices.
